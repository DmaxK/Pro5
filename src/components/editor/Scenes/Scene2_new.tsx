...
export function Scene2() {
  ...
  return (
    <group dispose={null} position={new Vector3(-5,0,-5)}>
      ...
      <mesh ref={windowRef1} geometry={nodes.Windows.geometry} material={materials.Glass_Placeholder_Windows} />
      <mesh receiveShadow geometry={nodes.Aset_building_combined_L_wdetbjudw_00_LOD5001.geometry} material={materials.house_1_base_1} />
      <mesh receiveShadow castShadow geometry={nodes.Aset_building_combined_L_wdetbjudw_00_LOD5001_1.geometry} material={materials.house_1_corner_big} />
      <mesh receiveShadow geometry={nodes.Aset_building_combined_L_wdetbjudw_00_LOD5001_2.geometry} material={materials.house_1_base_2} />
      <mesh receiveShadow castShadow geometry={nodes.Aset_building_combined_L_wdetbjudw_00_LOD5001_3.geometry} material={materials.house_1_corner_small} />
      <mesh receiveShadow geometry={nodes.Aset_building_combined_L_wdetbjudw_00_LOD5001_4.geometry} material={materials.house_1_floor_1} />
      <mesh receiveShadow castShadow geometry={nodes.Aset_building_combined_L_wdetbjudw_00_LOD5001_5.geometry} material={materials.house_1_corner_middle} />
      <mesh receiveShadow castShadow geometry={nodes.Aset_building_combined_L_wdetbjudw_00_LOD5001_6.geometry} material={materials.house_1_trim} />
      <mesh receiveShadow geometry={nodes.Aset_building_combined_L_wdetbjudw_00_LOD5001_7.geometry} material={materials.house_1_floor_4} />
      <mesh castShadow geometry={nodes.Aset_building_combined_L_wdetbjudw_00_LOD5001_8.geometry} material={materials.house_1_roof} />
      <mesh castShadow geometry={nodes.Aset_building_combined_L_wdetbjudw_00_LOD5001_9.geometry} material={materials.house_1_floor_2} />
      <mesh castShadow geometry={nodes.Aset_building_combined_L_wdetbjudw_00_LOD5001_10.geometry} material={materials.house_1_floor_3} />
      <mesh castShadow receiveShadow geometry={nodes.Aset_building_combined_L_wdetbjudw_00_LOD5001_11.geometry} material={materials.house_1_window_roof} />
      <mesh receiveShadow castShadow geometry={nodes.Aset_building_combined_L_vliqebjdw_01_LOD5001.geometry} material={materials.house_2_roof} />
